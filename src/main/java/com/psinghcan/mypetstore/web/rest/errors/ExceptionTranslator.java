...
public class ExceptionTranslator extends ResponseEntityExceptionHandler {
    ...
    private ProblemDetailWithCause getProblemDetailWithCause(Throwable ex) {
        if (
            ex instanceof com.psinghcan.mypetstore.service.EmailAlreadyUsedException ||
            ex instanceof com.psinghcan.mypetstore.service.UsernameAlreadyUsedException
        ) {
        ...
        if (
            ex instanceof com.psinghcan.mypetstore.service.InvalidPasswordException
